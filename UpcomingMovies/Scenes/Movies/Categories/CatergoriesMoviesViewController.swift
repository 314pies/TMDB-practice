...
class CatergoriesMoviesViewController: UIViewController, Storyboarded, SegueHandler {
    
    var viewModel: CatergoriesMoviesViewModel!
...
extension CatergoriesMoviesViewController: TabBarScrollable {
...
extension CatergoriesMoviesViewController: UISearchResultsUpdating {
...
extension CatergoriesMoviesViewController: UISearchBarDelegate {
...
extension CatergoriesMoviesViewController: SearchMoviesResultControllerDelegate {
...
extension CatergoriesMoviesViewController: SearchOptionsTableViewControllerDelegate {
...
extension CatergoriesMoviesViewController {
